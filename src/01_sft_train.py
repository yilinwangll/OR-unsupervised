...
from src.utils.data import CustomDataset
...
def main():
    ...
    if model_args.use_lora:
        ...
        # For LoRA + gradient_checkpointing, we need to enable it after applying LoRA
        # and use use_reentrant=False to avoid issues with DDP
        if training_args.gradient_checkpointing:
            logger.info("Enabling gradient checkpointing for LoRA model...")
